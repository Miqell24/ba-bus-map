...
export const RULES = { style: 'title',
  // the feed's "?" stands for the ordinal º here ("Humberto 1º", "1º de Agosto")
  stopRe: [[/(?<=\b\d)\?(?= |$)/g, 'º'], [/^Yagán Yagán /, 'Yagán ']],
  stops: { 'Colec. Oeste Ramal Pilar y Ruta 26 (San Sebastián!': 'Colec. Oeste Ramal Pilar y Ruta 26 (San Sebastián)' },
};
